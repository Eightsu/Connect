...
import {createProfile, getCurrentProfile} from '../../actions/profile'; //both to create/update
      ...
      <form className="form" onSubmit={(e) => onSubmit(e)}>
        ...
        <div className="my-2">
          <button onClick={() => toggleSocialInputs(!displaySocialInputs)} type="button" className="btn btn-light">
            {displaySocialInputs ? <Fragment><p>Hide Social</p></Fragment> : <Fragment><p> Add Social</p></Fragment>}
          </button>
          <span style={{ fontSize: '12px' }}><em>Optional</em></span>
        </div>
...
// without withRouter we cannot use the history object to pass the action